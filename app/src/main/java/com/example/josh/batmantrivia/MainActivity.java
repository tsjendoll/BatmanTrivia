...
public class MainActivity extends AppCompatActivity {
    ...
    public void calculateScore(View view) {
        ...
        RadioButton rb7 = (RadioButton) findViewById(R.id.radio_oracle);
        RadioButton rb8 = (RadioButton) findViewById(R.id.radio_ras);
        RadioButton rb9 = (RadioButton) findViewById(R.id.radio_Talia);
        ...
        RadioButton[] radio_array = {rb1,rb2,rb3,rb4,rb5,rb6,rb7,rb8,rb9};
